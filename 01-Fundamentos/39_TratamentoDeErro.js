...
const obj = { nome: 'Marcus' }; //  Aqui estamos chamando uma variável Nome que nem foi declarado
//const obj = { name: 'Marcus' }; //  Aqui é a forma correta , para a função não ocorrer o erro 
imprimirNomeGritando(obj);